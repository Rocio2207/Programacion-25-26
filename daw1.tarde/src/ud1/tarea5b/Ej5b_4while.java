...
public class Ej5b_4while {
	public static void main(String[] args) {
		Scanner sc = new Scanner (System.in);
		
		System.out.println("Por favor, introduxca el número de horas trabajadas durante la semana");
		...
		System.out.println("El sueldo por tabajar " +horasTrabajadas+ " es "+salarioSemanal);
