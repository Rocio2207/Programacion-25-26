...
public class Repaso1Plantilla {
	...
	static char[] funcion1(String cad1, String cad2) {
		String concatenadas = cad1.toLowerCase() +" "+ cad2.toLowerCase() ;
		
		char[] resultado = concatenadas.toCharArray() ;
	...
	static char[] funcion2(String cad1, String cad2) {
		String concatenadas = cad2 +" "+ cad1;
		char[] resultado = concatenadas.toUpperCase().toCharArray();
	...
	static int funcion3(char car, String cad) {
		int resultado = Character.getNumericValue(car) + Integer.parseInt(cad);
