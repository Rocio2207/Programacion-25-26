...
public class LoteriaSolucion {	
	...
	public static String heSidoAgraciado(String[] numerosSorteo, String[] premiosSorteo, String miDecimo){
		...
		for (int i=0;i<numerosSorteo.length;i++) {
			...
			if (premiosSorteo[i].equals("PRIMER PREMIO")) {
				
				if (numerosSorteo[i].charAt(0) == miDecimo.charAt(0) && numerosSorteo[i].charAt(1) == miDecimo.charAt(1) && numerosSorteo[i].charAt(2) == miDecimo.charAt(2)) {
					premio = ("Agraciado con: 100€");}
				
				if(numerosSorteo[i].charAt(3) == miDecimo.charAt(3) && numerosSorteo[i].charAt(4) == miDecimo.charAt(4)){
						premio = ("Agraciado con: 100€");}
				
				if( numerosSorteo[i].charAt(4) == miDecimo.charAt(4)){
					premio = ("Agraciado con: 20€");}
				
				
				
				
				
				int numero = Integer.parseInt(numerosSorteo[i]);
				int Decimo = Integer.parseInt(miDecimo);
				if (Decimo == (numero +1) || Decimo == (numero -1))
					premio = ("Agraciado con: 2000€");
			}
			
			if (premiosSorteo[i].equals("SEGUNDO PREMIO")) {
				if (numerosSorteo[i].charAt(0) == miDecimo.charAt(0) && numerosSorteo[i].charAt(1) == miDecimo.charAt(1) && numerosSorteo[i].charAt(2) == miDecimo.charAt(2)) {
					premio = ("Agraciado con: 100€");
				}
				...
				int Decimo = Integer.parseInt(miDecimo);
				if (Decimo == (numero +1) || Decimo == (numero -1))
					premio = ("Agraciado con: 1250€");
			}
			
			if (premiosSorteo[i].equals("TERCER PREMIO")) {
				if (numerosSorteo[i].charAt(0) == miDecimo.charAt(0) && numerosSorteo[i].charAt(1) == miDecimo.charAt(1) && numerosSorteo[i].charAt(2) == miDecimo.charAt(2)) {
					premio = ("Agraciado con: 100€");
				}
				...
				int Decimo = Integer.parseInt(miDecimo);
				if (Decimo == (numero +1) || Decimo == (numero -1))
					premio = ("Agraciado con: 960€");
			}
			
			if (premiosSorteo[i].equals("CUARTO PREMIO")) {
				if (numerosSorteo[i].charAt(0) == miDecimo.charAt(0) && numerosSorteo[i].charAt(1) == miDecimo.charAt(1) && numerosSorteo[i].charAt(2) == miDecimo.charAt(2)) {
					premio = ("Agraciado con: 100€");
				}
			}
